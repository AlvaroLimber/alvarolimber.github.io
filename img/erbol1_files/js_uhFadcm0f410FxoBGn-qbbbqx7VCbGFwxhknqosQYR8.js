(function ($) {
  Drupal.behaviors.erbol_radiolive = {
    attach: function (context, settings) {
      var hosts_size = $('#radio-live-host-number', context).val();
      var i = 1;
      ...
      else if(Drupal.settings.erbol_radiolive.hosts.length > 0) {
        resizeHost(0);
      }
      ...
      function changeImage(i) {
        var position = i+1;
        $('#radio-host-name .host-name', context).removeClass('hidden');
        $('#radio-host-name .host-name', context).addClass('hidden');
        $('#radio-host-name .host-name:nth-child('+position+')', context).removeClass('hidden');
        $('.radio-photo', context).html(Drupal.settings.erbol_radiolive.hosts[i]['photo']);
        resizeHost(i);
      }

      function resizeHost(i) {
        //console.log(Drupal.settings.erbol_radiolive.hosts[i]['photo']);
        if(Drupal.settings.erbol_radiolive.hosts[i]['photo'] == '' || Drupal.settings.erbol_radiolive.hosts[i]['photo'] == null) {
          $('.radio-host', context).removeClass('col-xs-9 col-sm-9 col-md-9 col-lg-9');
          $('.radio-host', context).addClass('col-xs-12 col-sm-12 col-md-12 col-lg-12');

          $('.radio-program', context).removeClass('col-xs-9 col-sm-9 col-md-9 col-lg-9');
          $('.radio-program', context).addClass('col-xs-12 col-sm-12 col-md-12 col-lg-12');
        }
        else {
          $('.radio-host', context).removeClass('col-xs-12 col-sm-12 col-md-12 col-lg-12');
          $('.radio-host', context).removeClass('col-xs-9 col-sm-9 col-md-9 col-lg-9');
          $('.radio-host', context).addClass('col-xs-9 col-sm-9 col-md-9 col-lg-9');

          $('.radio-program', context).removeClass('col-xs-12 col-sm-12 col-md-12 col-lg-12');
          $('.radio-program', context).addClass('col-xs-9 col-sm-9 col-md-9 col-lg-9');
        }
      }
    }
  };
